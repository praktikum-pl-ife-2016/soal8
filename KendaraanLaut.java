public class KendaraanLaut implements Kendaraan1, Komponen {
private String nama,nomorProduksi,manufaktur,warna;
 
public KendaraanLaut(String nm, String np, String wa, String ma) {
nama=nm;
nomorProduksi=np;
manufaktur = ma;
warna=wa;
...
@Override
public void fuel() {
System.out.println("Bahan bakar kendaraan tersebut adalah solar atau uranium.");
}
}
